...
public class Individus extends JPanel{
	...
	public Individus(Animal[] A_list) throws InterruptedException {
	...
	private  void setGrilleAnimal() throws InterruptedException {
